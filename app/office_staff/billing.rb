ActiveAdmin.register Billing, namespace: 'office_staff' do
  menu false
  belongs_to :site
  ...
  action_item 'Contract', only: [:edit, :new, :show] do
    link_to 'Contract', office_staff_site_contract_url(site, billing.contract)
  end

  action_item 'Project', only: [:edit, :new, :show] do
    link_to 'Project', office_staff_site_project_url(site, billing.project)
  end
  ...
  action_item 'Cancel', only: [:edit] do
    link_to 'Cancel', office_staff_site_billing_url(site, billing)
  end
