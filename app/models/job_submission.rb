class JobSubmission < ActiveRecord::Base
  ...
  SHINGLE_MANUFACTURER = {1 => 'GAF', 2 => 'Owens Corning', 3 => 'Certainteed', 4 => 'Decra'}
  SHINGLE_TYPE = {1=>"Timberline HD", 2=>"ArmourShield 2 IR", 3=>"Grand Sequoia IR", 4=>"Grand Sequoia", 5=>"Grand Canyon", 6=>"Camelot 2", 7=>"Sienna", 8=>"Woodland", 9=>"Monaco", 10=>"Duration", 11=>"Duration Storm IR", 12=>"Woodmoor", 13=>"Woodcrest", 14=>"Presidential Shake", 15=>"Presidential Shake IR", 16=>"Presidential TL", 17=>"Tile", 18=>"Villa Tile", 19=>"Shake", 20=>"Shake XD"}
  WORK_TYPE = {  }
